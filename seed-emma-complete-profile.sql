-- ============================================
-- COMPLETE EMMA CHRONIC PAIN PROFILE
...
BEGIN
    ...
    -- Tags: absolutely_broken, train_wreck, joint_pain, fatigue_crash, poor_sleep
    v_date := '2025-09-01';
    ...
    INSERT INTO journal_entries (profile_id, title, content, entry_date, public, created_at)
    VALUES (
        v_emma_profile_id,
        'Rock Bottom',
    ...
    -- ============================================
    -- STEP 9: FOLLOWERS (50 followers)
    -- ============================================
    
    -- Create 50 verified followers for Emma
