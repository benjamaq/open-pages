...
export default function TimelineStorySection() {
  return (
    <section className="timeline-section bg-gradient-to-br from-[#1e3a8a] via-[#0f766e] to-[#854d0e] py-20 px-6">
      <div className="container mx-auto max-w-6xl text-center">
        ...
        <div className="timeline-cards grid grid-cols-1 md:grid-cols-4 gap-6 mt-10 mb-8">
          <div className="timeline-card rounded-2xl border border-slate-200 bg-white/95 backdrop-blur p-6 text-left shadow-lg hover:shadow-xl transition-all">
          ...
          <div className="timeline-card rounded-2xl border border-amber-300 bg-amber-50/90 backdrop-blur p-6 text-left shadow-lg hover:shadow-xl transition-all">
