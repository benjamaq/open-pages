            ...
            <div className="bg-gray-50 rounded-2xl p-8 shadow-sm border border-gray-200">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                  <button className="px-3 py-1.5 text-sm rounded-full bg-indigo-600 text-white">Mood</button>
                  <button className="px-3 py-1.5 text-sm rounded-full bg-gray-100 text-gray-600">Pain</button>
                  <button className="px-3 py-1.5 text-sm rounded-full bg-gray-100 text-gray-600">Sleep</button>
                </div>
              </div>
