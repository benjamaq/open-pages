...
BEGIN
  ...
  INSERT INTO daily_entries (
    ...
    sleep_hours, night_wakes, tags, journal, wearables
  ) VALUES (
    p_user_id, p_local_date, p_mood, p_sleep_quality, p_pain,
    p_sleep_hours, p_night_wakes, p_tags, p_journal, COALESCE(p_wearables, '{}'::jsonb)
  )
  ...
  DO UPDATE SET
    ...
    wearables = COALESCE(EXCLUDED.wearables, '{}'::jsonb),
    updated_at = NOW();
