      ...
      <main className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl border border-neutral-200 shadow-sm p-8">
            <h2 className="text-2xl font-bold text-neutral-900 mb-2">Just Looking</h2>
          ...
          <div className="bg-white rounded-2xl border-2 border-black shadow-lg p-8 relative">
            ...
            <h2 className="text-2xl font-bold text-neutral-900 mb-2">Getting Serious</h2>
            <p className="text-sm text-neutral-600 mb-6">€12/month</p>
            <div className="text-5xl font-bold text-neutral-900 mb-6">€12<span className="text-base font-normal text-neutral-600">/month</span></div>
            <ul className="space-y-3 text-neutral-700 mb-8">
              <li>Unlimited supplements</li>
              <li>Wearable sync (Whoop, Oura, Apple)</li>
