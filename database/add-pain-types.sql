-- Add pain_types column to daily_entries table
-- This migration adds the pain_types field to support the enhanced daily check-in

-- Add the pain_types column if it doesn't exist
ALTER TABLE daily_entries
ADD COLUMN IF NOT EXISTS pain_types TEXT[] DEFAULT '{}'::TEXT[];

-- Update the RPC function to handle the new pain_types parameter
