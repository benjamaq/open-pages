...
import { updateStackItem } from '../lib/actions/stack'
...
interface EditStackItemFormProps {
  item: StackItem
  onClose: () => void
}

export default function EditStackItemForm({ item, onClose }: EditStackItemFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to update stack item.')
    } finally {
      setIsLoading(false)
    }
  }
