-- Create Emma's complete profile with real user ID
...
DECLARE
    ...
    v_date DATE;
BEGIN
    RAISE NOTICE 'Creating Emma profile for user: %', v_emma_user_id;
    ...
    RAISE NOTICE 'Created Emma profile with ID: %', v_emma_profile_id;
