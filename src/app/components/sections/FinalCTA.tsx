  ...
  return (
    <section className="py-24 bg-gradient-to-br from-teal-700 to-amber-600 text-white text-center">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <Link href="/auth/signup" className="inline-block bg-[#F4B860] hover:bg-[#E5A850] text-gray-900 font-semibold text-base md:text-lg px-6 md:px-8 py-3 md:py-3.5 rounded-full transition-colors shadow-lg hover:shadow-xl whitespace-nowrap">Start Free — 20 seconds a day</Link>
        <p className="text-sm mt-4 opacity-80">No app store • No wearable • Private by default</p>
      </div>
    </section>
  );
}
