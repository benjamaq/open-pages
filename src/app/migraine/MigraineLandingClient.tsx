  ...
  return (
    <main>
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        {/* Gradient (softer for migraine) */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#312E81] via-[#4C1D95] to-[#E8B86D] opacity-95" />
        ...
        <Container className="relative z-10 px-6 pt-28 sm:pt-32">
          <div className="max-w-4xl">
            ...
            <p className="text-sm text-white/80 mb-1 font-semibold">Gentle on hard days. Clear when it matters.</p>
            <p className="mt-2 text-sm text-white/80">Install in one tap · Daily reminders · 20 seconds/day · Private by default</p>
            <div className="mt-3 text-xs text-white/80">✓ Built by a chronic pain survivor · Analyzed 47,000+ patterns · Private by default</div>
          </div>
        </Container>
      </section>
      ...
      <Section className="bg-white">
        <Container>
          <div className="text-center mb-10">
            <h2 className="text-3xl lg:text-4xl font-bold text-black mb-2">Here's What BioStackr Actually Tells You</h2>
            <p className="text-gray-600">Not graphs. Clear patterns you can act on.</p>
          </div>
      ...
      <Section className="bg-white">
        <Container>
          ...
          <div className="flex gap-6 overflow-x-auto pb-6 snap-x snap-mandatory scrollbar-hide">
            {[
              { q:'"BioStackr showed my red wine + <6h sleep combo was the problem—not either one alone. Cutting that combo cut my attacks by ~70% in 3 weeks. I finally feel like I have my life back."', n:'Sarah, 34' },
              { q:'"My neurologist wanted a diary. I needed an analyst. BioStackr found the specific patterns I never would have seen—including pressure drops 48h before attacks. The hours I wasted are finally over."', n:'Michael, 41' },
              { q:'"I get aura when pressure drops + late screens. The app warns me on those days; blue‑light early off + magnesium has kept me functional. I haven\'t taken a triptan in 6 weeks."', n:'Jessica, 29' },
            ].map((t,i)=> (
      ...
      <Section className="bg-white">
        <Container>
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-4 text-4xl lg:text-5xl font-bold text-black">Stop living around your migraines</h2>
            <p className="mb-2 text-xl text-gray-600">Start today—most people see usable patterns in 5–7 days.</p>
            <Link
              href="/auth/signup"
            ...
            <p className="mt-6 text-sm text-gray-500">Install in one tap · Daily reminders · Private by default</p>
          </div>
        </Container>
      </Section>
