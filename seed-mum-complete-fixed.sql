-- ============================================
-- MUM COMPLETE PROFILE - FIXED VERSION
-- ============================================
-- This creates the complete pain progression with:
-- - July 27-31: Baseline tracking (yellow colors)
-- - August 1-31: Complete pain journey with correct colors
-- - September 1-6: Continued tracking (green colors)
-- - All sections: supplements, protocols, journal, followers, gear, library
...
BEGIN
    ...
    -- ============================================
    -- COMPLETE PROFILE DATA (supplements, protocols, etc.)
    -- ============================================
...
To anyone reading this who''s struggling with chronic pain: don''t give up. Keep experimenting. Track everything. Find your combination. There is hope.', true, '2025-08-31');
    ...
    (v_mum_profile_id, 'Vitamin D Lab Results - Quest', 'lab_results', true, 'Quest Diagnostics', 'Vitamin D level was severely deficient at 18 ng/mL (normal: 30-100 ng/mL). Started 2000 IU daily supplementation.', 'application/pdf', 189440, '/uploads/mum/vitamin-d-lab-quest.pdf', '2025-08-15'),
    ...
    (v_mum_profile_id, 'Inflammatory Markers - LabCorp', 'lab_results', true, 'LabCorp', 'CRP and ESR levels elevated, indicating systemic inflammation. Omega-3 and curcumin protocol recommended.', 'application/pdf', 245760, '/uploads/mum/inflammatory-markers-labcorp.pdf', '2025-08-20'),
    (v_mum_profile_id, 'Sleep Study Results', 'medical_report', true, 'Sleep Medicine Associates', 'Mild sleep apnea and frequent awakenings. Sleep hygiene and melatonin protocol recommended.', 'application/pdf', 512000, '/uploads/mum/sleep-study-results.pdf', '2025-08-10');
