-- Enhanced Daily Entries Schema for BioStackr (Safe Version)
-- Run this in your Supabase SQL editor - handles existing objects gracefully
...
drop policy if exists "Users can view and update own daily_entries" on daily_entries;
