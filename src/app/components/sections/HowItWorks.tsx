    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-4">
          <p className="text-base md:text-lg text-gray-600 mb-2">Here’s how BioStackr uncovers patterns like these.</p>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">From Check‑In to Clarity</h2>
        </div>
