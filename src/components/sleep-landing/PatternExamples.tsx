      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <PatternCarousel
          patterns={[
            ...
            { emoji: '🥛', title: 'Evening Dairy', description: 'Sleep quality drops from 7/10 → 4/10 when you have dairy after 6pm. Earlier? Minimal impact.', insight: 'Timing matters: late dairy can cause subtle digestive issues that disrupt sleep.', borderColor: 'border-red-200', bgColor: 'bg-red-50' },
            ...
            { emoji: '🌡️', title: 'Room Temperature', description: 'Your sleep quality drops from 7/10 → 4/10 when room temperature is above 70°F.', insight: 'Your body needs to cool down (65–68°F) to enter deep sleep.', borderColor: 'border-blue-300', bgColor: 'bg-blue-50' },
            { emoji: '🌑', title: 'Room Darkness', description: 'Your sleep quality averages 4/10 with ambient light vs 7/10 in complete darkness.', insight: 'Even small amounts of light disrupt melatonin production.', borderColor: 'border-indigo-300', bgColor: 'bg-indigo-50' },
            { emoji: '📅', title: 'Weekend Schedule', description: 'Monday–Thursday sleep averages 5/10 after weekends with 2+ hour schedule shifts vs 7/10 when consistent.', insight: 'Your circadian rhythm needs consistency; big weekend shifts ripple through the week.', borderColor: 'border-pink-300', bgColor: 'bg-pink-50' },
            { emoji: '📱', title: 'Phone Location', description: 'Sleep quality at 7/10 when phone charges in kitchen vs 4/10 when on nightstand.', insight: 'The temptation to check disrupts wind‑down, even on silent.', borderColor: 'border-gray-300', bgColor: 'bg-gray-50' },
            ...
            { emoji: '🛁', title: 'Wind‑Down Routine', description: 'Your sleep quality averages 7/10 on nights with a 30‑minute wind‑down vs 4/10 without.', insight: "Your body needs a consistent signal that it's time to sleep.", borderColor: 'border-teal-300', bgColor: 'bg-teal-50' },
